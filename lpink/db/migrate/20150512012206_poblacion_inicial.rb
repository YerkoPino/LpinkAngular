class PoblacionInicial < ActiveRecord::Migration
  def change
    ...
    participante.id = '1'
    participante.email = 'yerko.pino@usach.cl'
    participante.participante_nombre = 'Yerko'
    participante.participante_apellido = 'Pino'
    participante.tipo = 'team'
    participante.participante_iniciales = 'YP'
    participante.password = '12345678'
    participante.password_confirmation = '12345678'
    participante.save!

    participante = Participante.new
    participante.id = '2'
    participante.email = 'ismael.vicencio@usach.cl'
    participante.participante_nombre = 'Imsael'
    participante.participante_apellido = 'Vicencio'
    participante.tipo = 'team'
    participante.participante_iniciales = 'IV'
    participante.password = '12345678'
    participante.password_confirmation = '12345678'
    participante.save!
    ...
    participante = Participante.new
    participante.id = '3'
    participante.email = 'daniel.vargas@usach.cl'
    participante.participante_nombre = 'Daniel'
    participante.participante_apellido = 'Vargas'
    participante.tipo = 'team'
    participante.participante_iniciales = 'DV'
    participante.password = '12345678'
    participante.password_confirmation = '12345678'
    participante.save!
    ...
    participante = Participante.new
    participante.id = '4'
    participante.email = 'camilo.jimenez@usach.cl'
    participante.participante_nombre = 'Camilo'
    participante.participante_apellido = 'Jimenez'
    participante.tipo = 'team'
    participante.participante_iniciales = 'YP'
    participante.password = '12345678'
    participante.password_confirmation = '12345678'
    ...
    participante = Participante.new
    participante.id = '5'
    participante.email = 'gonzalo.martinez@usach.cl'
    participante.participante_nombre = 'Gonzalo'
    participante.participante_apellido = 'Martinez'
    participante.tipo = 'team'
    participante.participante_iniciales = 'GM'
    participante.password = '12345678'
    participante.password_confirmation = '12345678'
    participante.save!
